const zh = {
  ...
  compoundInterest: {
    ...
    interestLabel: "利息",
    realTotalLabel: "扣通胀后",
    doubledLegend: "🎉 资产到达初始投资的 2/4/8/16... 倍",
    ageColumn: "年龄",
  },
  backgroundRemover: {
    upload: "点击或拖拽上传图片",
...
const en: Translations = {
  ...
  compoundInterest: {
    ...
    inflationAdjustment: "Adjust for inflation",
    inflationRate: "Annual Inflation Rate (%)",
    finalAmount: "Final amount",
    totalInvested: "Total invested",
    totalInterest: "Total interest",
    realValue: "Real value (today's $)",
    investedLabel: "Invested",
    interestLabel: "Interest",
    realTotalLabel: "After inflation",
    doubledLegend: "🎉 Total reached 2/4/8/16x of initial investment",
    ageColumn: "Age",
  },
  backgroundRemover: {
    upload: "Click or drag to upload an image",
